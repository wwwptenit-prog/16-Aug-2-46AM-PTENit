    ...
    <section className="py-8 sm:py-12 bg-slate-50 dark:bg-slate-900/80">
      <div className="max-w-[1920px] mx-auto px-3 sm:px-8 md:px-12 lg:px-16 xl:px-20 space-y-10 sm:space-y-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
            ...
            {setActiveTab && !isStandalonePage && (
              <button
                ...
                className="px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-[#1DB954]/10 hover:bg-[#1DB954] text-[#1DB954] hover:text-white border border-[#1DB954]/30 font-black text-xs sm:text-sm md:text-base transition-all shadow-xs flex items-center gap-2 cursor-pointer font-bengali shrink-0 group active:scale-95"
              >
          ...
          {/* Agency Services Grid (5 cols PC x 1 row, 2 cols Phone x 2 rows) */}
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-2.5 sm:gap-4 lg:gap-5">
