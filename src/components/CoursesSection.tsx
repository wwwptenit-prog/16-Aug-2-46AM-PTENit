        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 sm:mb-8 border-b border-slate-200 dark:border-slate-800 pb-4">
          ...
          {!isStandalonePage && setActiveTab && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[#1DB954] hover:text-emerald-400 font-bold text-xs sm:text-sm hover:underline transition-all cursor-pointer font-bengali shrink-0 group"
            >
