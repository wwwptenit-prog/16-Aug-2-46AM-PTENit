...
export const initialDigitalProducts: DigitalProduct[] = [
  ...
  },
  {
    ...
    fullDescription: "ফেসবুক, গুগোল ও কাস্টমার লিড গ্রুপে বাল্ক মেসেজিং অটোমেশন টুল। ১০০% ডেলিভারি রেট, প্রক্সি ফিল্টার এবং লাইফটাইম অফিসিয়াল লাইসেন্স কি ইন্সট্যান্ট ইমেইল করা হবে।",
    deliveryType: "auto",
    ...
    reviewsCount: 88,
    salesCount: 310,
    features: ["১ ক্লিকে বাল্ক এসএমএস সেন্ডিং", "ইমেইল টেমপ্লেট মেকার", "লাইফটাইম অফিশিয়াল কি", "ইনস্ট্যান্ট অটো ইমেইল ফাইল"],
    downloadUrl: "https://drive.google.com/file/d/ptenit-marketing-automation/view?usp=sharing",
    licenseKey: "PTENIT-AUTO-MARKETING-KEY"
  },
  {
    id: "dp-5",
    ...
    fullDescription: "ডিজাইনার ও ডেভেলপারদের জন্য মেগা ইউআই বান্ডেল। ১০০+ প্রিমিয়াম স্ক্রিন, কাস্টম ইল্যাস্ট্রেশন, ভেক্টর আইকন ও ফিগমা এক্সেস। পেমেন্টের সাথে সাথেই ইমেইলে লিঙ্ক চলে যাবে।",
    deliveryType: "auto",
    ...
    reviewsCount: 112,
    salesCount: 450,
    features: ["১০০+ কমপ্লিট ইউআই স্ক্রিন", "১০০% কাস্টমাইজেবল ফিগমা", "ভেক্টর ইল্যাস্ট্রেশন ফাইল", "ইনস্ট্যান্ট অটো ফাইল ইমেইল"],
    downloadUrl: "https://drive.google.com/file/d/ptenit-figma-uiux-bundle/view?usp=sharing",
    licenseKey: "PTENIT-FIGMA-UIKIT-ACCESS"
  }
];
